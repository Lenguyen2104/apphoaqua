...
public interface ReferenceCodeRepository extends JpaRepository<ReferenceCode, String> {
    ...
    @Query("SELECT NEW com.security.apphoaqua.dto.response.referencecode.GetReferenceCodeResponse(rc.id, rc.createdBy, u.username, u.phone, rc.referenceCode, rc.createdDate) " +
