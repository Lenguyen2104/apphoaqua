...
public class Message {
    ...
    public static final String CALENDAR_INVALID_TITLE = "Lịch chưa có tiêu đề";
    ...
    public static final String INVALID_DATA_CONNECT_SYSTEM = "Dữ liệu kết nối không khớp khi đăng kí";
